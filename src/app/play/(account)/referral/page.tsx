...
export default function ReferralPage() {
 ...
 <div className="mt-6 rounded-sm bg-card p-6 text-center">
 ...
 <p className="mt-2 font-display text-3xl font-extrabold tracking-[0.2em] text-primary">
          ...
          <button
            onClick={copy}
 className="mt-4 inline-flex items-center gap-2 rounded-sm bg-foreground px-4 py-2.5 font-display text-sm font-bold text-background transition-all"
          >
 ...
 className="mt-4 inline-flex items-center gap-2 rounded-sm bg-foreground px-5 py-2.5 font-display text-sm font-bold text-background transition-all"
      ...
      {profile && !profile.referred_by && (
        <form
          onSubmit={redeem}
 className="mt-4 rounded-sm bg-card p-6"
        >
 ...
 className="flex-1 rounded-sm border border-border bg-background px-3 py-2.5 text-sm font-semibold tracking-[0.15em] text-foreground outline-none placeholder:text-foreground/40 focus-visible:border-accent"
            />
            <button
              type="submit"
              disabled={redeeming || !sponsorCode.trim()}
 className="shrink-0 rounded-sm bg-foreground px-5 py-2.5 font-display text-sm font-bold text-background transition-all disabled:opacity-50 disabled:hover:translate-x-0 disabled:hover:translate-y-0"
            >
              {redeeming ? "…" : "Valider"}
            </button>
          </div>
 ...
 <p className="mt-3 text-sm font-semibold text-foreground/60">
      ...
      {myRank != null && (
 <div className="mt-4 flex items-center justify-center gap-2 rounded-sm bg-sun p-4 font-display text-base font-extrabold text-foreground">
 ...
 <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-border bg-primary font-display text-sm font-extrabold text-primary-foreground">
