...
export default function EditProfilePage() {
 ...
 <div className="mx-auto max-w-2xl">
      <Link
        href="/play/account"
 className="inline-flex items-center gap-1.5 rounded-sm bg-card px-3.5 py-2 font-display text-xs font-bold text-foreground transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:bg-surface-2 hover:shadow-none"
      >
 ...
 <h1 className="mt-4 font-display text-2xl font-extrabold tracking-tight lg:text-3xl">
      ...
      <form
        onSubmit={save}
 className="mt-6 rounded-sm bg-card p-5 sm:p-8"
      >
        {/* ---- Photo de profil ---- */}
 ...
 className="relative h-28 w-28 shrink-0 overflow-hidden rounded-full border border-border bg-surface-2"
 ...
 <span className="absolute -bottom-1 -right-1 grid h-10 w-10 place-items-center rounded-full border border-border bg-foreground text-background">
 ...
 <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
              <button
                type="button"
                onClick={() => fileRef.current?.click()}
 className="inline-flex items-center justify-center gap-2 rounded-sm bg-foreground px-5 py-2.5 font-display text-sm font-bold text-background transition-all"
              >
 <Camera className="h-4 w-4" strokeWidth={2.5} />
                Changer la photo
              </button>
 ...
 <p className="text-sm font-semibold text-vert-deep sm:col-span-2">
          ...
          <button
            disabled={saving}
 className="w-full rounded-sm bg-foreground py-3 font-display text-sm font-bold text-background transition-all disabled:opacity-50 disabled:hover:translate-x-0 disabled:hover:translate-y-0 sm:col-span-2"
          >
