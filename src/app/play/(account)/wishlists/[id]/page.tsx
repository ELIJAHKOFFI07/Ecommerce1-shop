 ...
 if (loading) return <div className="space-y-6"><HeaderSkeleton /><ProductGridSkeleton /></div>;
  ...
  return (
    <div>
      <Link
        href="/play/wishlists"
 className="mb-4 inline-flex items-center gap-1.5 rounded-sm bg-card px-3.5 py-2 font-display text-xs font-bold text-foreground transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:bg-surface-2 hover:shadow-none"
      >
