...
export default function CartPage() {
 ...
 <span className="text-lg font-bold text-accent">
        ...
        <Link
          href="/play/checkout"
 className="press mt-5 block rounded-sm bg-foreground py-3 text-center font-semibold text-background"
        >
          Passer la commande
        </Link>
        <Link
          href="/play"
 className="press mt-3 block rounded-sm border border-border py-2.5 text-center text-sm transition-colors hover:border-accent hover:text-accent"
        >
