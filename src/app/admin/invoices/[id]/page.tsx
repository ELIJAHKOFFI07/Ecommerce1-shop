...
export default function InvoiceDetailPage({
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-2xl rounded-2xl border border-border bg-surface p-8 text-sm print:border-0 print:bg-white print:text-background">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-xl font-bold text-accent print:text-background">DreamTeamShop</p>
        ...
        <div className="ml-auto mt-4 w-56 space-y-1">
          ...
          <div className="flex justify-between border-t border-border pt-1 font-bold">
            <span>Total</span>
            <span className="text-accent print:text-background">{formatFcfa(order.total)}</span>
          </div>
        </div>
