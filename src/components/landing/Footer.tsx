    ...
    <footer className="border-t-2 border-border bg-foreground text-background">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          >
            <span className="grid h-10 w-10 rotate-[-6deg] place-items-center rounded-xl border-2 border-background/20 bg-primary">
          ...
          <div className="mt-6 flex gap-2.5">
            {PAYMENTS.map((payment) => (
              <span
                key={payment}
                className="rounded-lg border border-background/20 bg-background/10 px-3 py-1.5 font-display text-xs font-bold"
              >
                {payment}
              </span>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-2.5 font-medium text-background/70">
      ...
      <div className="border-t border-background/10">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-6 text-sm text-background/50 sm:px-6">
          <p>© 2026 DreamTeamShop — Fait avec fierté à Abidjan.</p>
          <p className="font-display font-bold text-background/60">
