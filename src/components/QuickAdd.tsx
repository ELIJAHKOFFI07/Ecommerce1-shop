...
/// notification qui se superpose à la page.
export function QuickAdd({ product }: { product: Omit<CartLine, "quantity"> }) {
  ...
  return (
    <button
      ...
      aria-live="polite"
      className={cx("press inline-flex h-11 shrink-0 cursor-pointer items-center gap-1.5 rounded-md px-4 text-sm font-semibold transition-colors", done ? "bg-success text-white" : "bg-primary text-primary-foreground hover:bg-secondary")}
    >
