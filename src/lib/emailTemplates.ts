 ...
 * Gabarits d'e-mail.
 *
 * Repris tel quel de supabase/functions/send-notification-email/templates.ts
 * (Edge Function Deno, abandonnée avec le reste du backend Supabase) — ce
 * fichier n'avait aucune dépendance Deno, la portée vers Next.js est directe.
 *
...
export type EmailKind = "order" | "offer" | "auction" | "message" | "price_drop" | "info";
